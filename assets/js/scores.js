...
// sorts the stored high scores in descending order 
...
// users name is capitalized.
  highScoreItem.textContent = storedHighScores[i].user.toUpperCase() + ": " + storedHighScores[i].score;
